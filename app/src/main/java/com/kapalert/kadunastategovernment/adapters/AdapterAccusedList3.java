...
public class AdapterAccusedList3 extends RecyclerView.Adapter<AdapterAccusedList3.AccusedHolder> {

    private Context mContext;
    private ArrayList<CreateCivilCaseActivity.AccusedModal1> mList;

    public AdapterAccusedList3(Context mContext, ArrayList<CreateCivilCaseActivity.AccusedModal1> mList) {
    ...
    public void onBindViewHolder(final AccusedHolder holder, int position) {
        final CreateCivilCaseActivity.AccusedModal1 data = mList.get(position);

        holder.name.setText(data.getName());
        holder.age.setText(data.getAge());
        holder.defand.setText(data.getDefand());
    ...
    public class AccusedHolder extends RecyclerView.ViewHolder {
        ...
        public AccusedHolder(View itemView) {
            ...
            defand=(TextView)itemView.findViewById(R.id.accused_gender);
