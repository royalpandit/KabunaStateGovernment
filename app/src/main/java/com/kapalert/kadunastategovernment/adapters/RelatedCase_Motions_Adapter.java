...
import static com.kapalert.kadunastategovernment.activities.Create_MotionCase_Activity.recycle_relatedCase_list;
import static com.kapalert.kadunastategovernment.activities.Create_MotionCase_Activity.tv_relatedCase;
import static com.kapalert.kadunastategovernment.utils.Constants.MOTION_RELATED_CASE_ID;

public class RelatedCase_Motions_Adapter extends RecyclerView.Adapter<RelatedCase_Motions_Adapter.MyViewHolder>
{
    Context mContext;
    List<Bean_RelatedCase_POJO> relatedCase_pojoList;
    TinyDB sessionManager;
    public RelatedCase_Motions_Adapter(Context mContext, List<Bean_RelatedCase_POJO> relatedCase_pojoList)
    {
       ...
       holder.tv_name.setText(caseName);
        ...
        holder.tv_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sessionManager.putString(MOTION_RELATED_CASE_ID,relatedCase_pojoList.get(position).getRelatedCase_id());
