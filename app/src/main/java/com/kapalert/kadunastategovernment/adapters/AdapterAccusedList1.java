...
public class AdapterAccusedList1 extends RecyclerView.Adapter<AdapterAccusedList1.AccusedHolder> {

    private Context mContext;
    private ArrayList<CreateCaseActivity.AccusedModal> mList;

    public AdapterAccusedList1(Context mContext, ArrayList<CreateCaseActivity.AccusedModal> mList) {
