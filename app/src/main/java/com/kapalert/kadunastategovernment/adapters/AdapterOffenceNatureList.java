...
public class AdapterOffenceNatureList extends RecyclerView.Adapter<AdapterOffenceNatureList.OffenceNatureHolder> {

    private Context mContext;
    private ArrayList<OffenceModal> mList;

    public AdapterOffenceNatureList(Context mContext, ArrayList<OffenceModal> mList) {
    ...
    public void onBindViewHolder(final OffenceNatureHolder holder, int position) {
        final OffenceModal data = mList.get(position);
