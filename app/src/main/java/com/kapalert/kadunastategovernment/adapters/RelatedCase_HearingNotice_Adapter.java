...
import static com.kapalert.kadunastategovernment.activities.Create_HearingNoticeCase_Acitivity.recycle_relatedCase_list;
import static com.kapalert.kadunastategovernment.activities.Create_HearingNoticeCase_Acitivity.tv_relatedCase;
import static com.kapalert.kadunastategovernment.utils.Constants.NOTICE_RELATED_CASE_ID;

public class RelatedCase_HearingNotice_Adapter extends RecyclerView.Adapter<RelatedCase_HearingNotice_Adapter.MyViewHolder>
{
    Context mContext;
    List<Bean_RelatedCase_POJO> relatedCase_pojoList;
    TinyDB sessionManager;
    public RelatedCase_HearingNotice_Adapter(Context mContext, List<Bean_RelatedCase_POJO> relatedCase_pojoList)
    {
       ...
       holder.tv_name.setText(caseName);
        ...
        holder.tv_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sessionManager.putString(NOTICE_RELATED_CASE_ID,relatedCase_pojoList.get(position).getRelatedCase_id());
