...
import static com.kapalert.kadunastategovernment.utils.Constants.MOTION_RELATED_CASE_ID;
...
public class Create_MotionCase_Activity extends AppCompatActivity {
   ...
   public static RecyclerView recycleFileList,recycle_relatedCase_list;
    ...
    RelatedCase_Motions_Adapter relatedCase_Motions_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create__motion_case);
        mContext = Create_MotionCase_Activity.this;
    ...
    private void allFieldsValid() {
        ...
        else
        {
            ...
            str_tvRelatedCase = sessionManager.getString(MOTION_RELATED_CASE_ID);
                    ...
                    if(jsonObject.getString("status").equalsIgnoreCase("true"))
                    {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                           ...
                           /// System.out.println("==hospital_modelList==============="+relatedCase_pojoList.size());
                            ...
                            relatedCase_Motions_adapter = new RelatedCase_Motions_Adapter(mContext, relatedCase_pojoList);
                            recycle_relatedCase_list.setAdapter(relatedCase_Motions_adapter);
                        }
                    }
                    else
                    {
...
//
    ...
    private void createCase(Context mContext, List<BeanUploadImage> beanUploadImages, String str_caseFileName, String str_caseFileReference, String str_tvRelatedCase, String str_assignTo)
    {
        ...
        entityBuilder.addTextBody("case","Motions");
