...
import com.kapalert.kadunastategovernment.adapters.RelatedCase_Appeal_Adapter;
import com.kapalert.kadunastategovernment.adapters.RelatedCase_Motions_Adapter;
...
public class Create_AppealCase_Activity extends AppCompatActivity {

    Spinner sp_assign;
    String assignvalue = "";
    public static EditText edt_case_filename,edt_caseFile_reference,edt_appeal_no;
    ...
    RelatedCase_Appeal_Adapter relatedCase_appeal_adapter;
    private  boolean RelatedCaseList_IsVisible = true;
    LinearLayout layout_relatedCase;
    TinyDB sessionManager;
    String str_caseFileName = "",str_caseFileReference= "",str_tvRelatedCase="", str_assignTo = "",str_appeal_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create__appeal_case);
        mContext = Create_AppealCase_Activity.this;
        ...
        edt_appeal_no = findViewById(R.id.edt_appeal_no);
        ...
        tv_relatedCase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(RelatedCaseList_IsVisible==false)
                {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equalsIgnoreCase("true"))
                    {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                            ...
                            relatedCase_appeal_adapter = new RelatedCase_Appeal_Adapter(mContext, relatedCase_pojoList);
                            recycle_relatedCase_list.setAdapter(relatedCase_appeal_adapter);
                        }
                    }
                    else
                    {
    ...
    private void allFieldsValid() {
        ...
        else if (edt_appeal_no.getText().toString().isEmpty()) {

            showToast(this, getString(R.string.invalid_appeal_number));
        }
        else if (tv_relatedCase.getText().toString().isEmpty() /*|| !mRefNum.getText().toString().matches("[0-9][0-9][0-9]/[0-9][0-9][0-9]")*/) {
            showToast(this, getString(R.string.please_select_related_case));
        ...
        else
        {
            ...
            str_appeal_no = edt_appeal_no.getText().toString();
            str_tvRelatedCase = sessionManager.getString(APPEAL_RELATED_CASE_ID);
            createCase(mContext, beanUploadImages,str_appeal_no, str_caseFileName,str_caseFileReference,str_tvRelatedCase,str_assignTo);
    ...
    private void createCase(Context mContext,List<BeanUploadImage> beanUploadImages,String str_appeal_no, String str_caseFileName,String str_caseFileReference,String str_tvRelatedCase,String str_assignTo)
    {
        ...
        entityBuilder.addTextBody("case","Appeals");
        ...
        entityBuilder.addTextBody("appeal_number",str_appeal_no);
